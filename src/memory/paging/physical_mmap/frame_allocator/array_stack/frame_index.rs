...
use crate::memory::types::{Byte, Bytes};
...
#[repr(C)]
pub struct FrameArrayIndex(pub u64);

impl FrameArrayIndex {
    pub const SIZE: Bytes = Bytes::new(core::mem::size_of::<Self>() as u64);
}

impl IntoIterator for FrameArrayIndex {
    type Item = Byte;
...
impl From<FrameArrayIndex> for FrameIndexByteIterator {
    fn from(frame_index: FrameArrayIndex) -> Self {
        Self {
